 ...
 */
mata::nfa::Nfa compute_ind(const mata::nft::Nft& abstraction_framework, const mata::nft::Nft& transition_relation, mata::Alphabet& concrete_alphabet, mata::Alphabet& abstract_alphabet, bool exclude_empty_abstractions = false, int verbosityLevel = logging::DEFAULT_VERBOSITY_LEVEL, bool measure_time = false);

// input: DETERMINISTIC abstraction framework!
mata::nft::Nft compute_preach_complement(const mata::nft::Nft& abstraction_framework, const mata::nft::Nft& transition_relation, mata::Alphabet& concrete_alphabet, mata::Alphabet& abstract_alphabet, std::optional<const mata::nfa::Nfa> ind = std::nullopt, int verbosityLevel = logging::DEFAULT_VERBOSITY_LEVEL, bool measure_time = false);
...
std::vector<bool> check_abstract_safety_explicit(const mata::nfa::Nfa& initial_configurations, const mata::nft::Nft& preach, std::vector<mata::nfa::Nfa> unsafe_properties, int verbosityLevel = logging::DEFAULT_VERBOSITY_LEVEL, bool measure_time = false);
std::vector<bool> check_abstract_safety_lazy(const mata::nfa::Nfa& initial_configurations, const mata::nft::Nft& preach_complement, std::vector<mata::nfa::Nfa> unsafe_properties, mata::Alphabet& concrete_alphabet, std::string universality_alg = "antichains", int verbosityLevel = logging::DEFAULT_VERBOSITY_LEVEL, bool measure_time = false);
